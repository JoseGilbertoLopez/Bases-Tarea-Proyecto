...
\usepackage{amsmath} % entornos matematicos
\usepackage{amssymb} % doble flecha

\begin{document}
  \begin{flushright}
    \begin{tabular}{r r}
        Naranjo Robledo Carlos & 313158412 \\
        Lopez Garcia Jose Gilberto & 313055552
    \end{tabular}
  \end{flushright}
  \begin{center}
    \large{(Tarea 5:) Dependencias y Normalización}
  \end{center}
  \begin{enumerate}
    ...
    \begin{enumerate}
      ...
      Cuando se necesita recuperar la información una vez se hayan hecho las
      particiones. Es decir cuando se quiere que no haya perdida de información
      en esquemas.
    \end{enumerate}
  ...
  no son válidas.
    \begin{enumerate}
      ...
      No necesariamente porque a un atributo en $A$ se le puede asociar mas de
      un valor de $C$, por ejemplo que una persona puede tener varios autos.
    ...
    \item[(3)] Para cada uno de los esuemas que se muestran a continuación:
        ...
        \begin{enumerate}
          \item[(a)] Dos dependencias funcionales no triviales: $AB \rightarrow CD$ y con $E \rightarrow C$
          ...
          \item[(b)] Dos dependencias funcionales no triviales son: $AB \rightarrow C$ y $DE \rightarrow C$
        	Una llave para R es : ABE
        	Todo es violacion.
    ...
    - Se ha decidido dividir $R$ en las siguientes relaciones $S(A,B,C,D,F)$ y
    $T(C,E)$, ¿Se puede recuperar la información de $R$?

    Si se puede porque esas relaciones coinciden con la $3NF$ que sabemos podemos
    recuperar información cuando esta en esa forma.
